document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, fieldName, extra) {
    const messages = {
      ...
      maxlength: 'Must be no more than ' + extra + ' characters.'
    };
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '93ab9a00-0e30-4e70-af38-75c7fa0bd741',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '93ab9a00-0e30-4e70-af38-75c7fa0bd741';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '93ab9a00-0e30-4e70-af38-75c7fa0bd741';
